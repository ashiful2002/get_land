...
import { MdNewReleases, MdOutlineRealEstateAgent } from "react-icons/md"; // রিয়েল এস্টেট এজেন্ট
import { TbBolt } from "react-icons/tb";         // দ্রুত/হাইলাইট
    ...
    return (
      <div className="card bg-base-100 dark:bg-base-300 shadow-xl">
        ...
        <div className="card-body">
          ...
          {/* <p
            className={`badge absolute -mt-12 -ml-4 text-sm font-medium badge-outline ${
              status ? "text-green-500 bg-gray-100/80" : "text-red-500"
            }`}
          >
            {isAdvertised ? "Verified" : "Not verified"}
          </p> */}
          <p
            className={`badge  text-sm font-medium badge-outline ${
              isAdvertised ? "text-secondary bg-gray-100/80" : "text-red-500"
            }`}
          >
            {isAdvertised ? (
              <>
          ...
          <p
            className={`badge absolute -mt-14 -ml-4 text-sm font-medium badge-outline ${
              isAdvertised ? "text-secondary bg-gray-100/80" : "text-red-500"
            }`}
          >
            {isAdvertised ? (
